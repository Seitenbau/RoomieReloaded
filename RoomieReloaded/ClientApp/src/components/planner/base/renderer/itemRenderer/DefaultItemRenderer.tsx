...
{
    private parentDataFactory: (index:number) => IPlannerItemParentData;
    ...
    private getCoveredRangeCount = (columnRanges: IHasDateRange[], item: IHasDateRange) : number =>
    {
        ...
        for (let columnRangeIndex = 0; columnRangeIndex < columnRanges.length; columnRangeIndex++) {
            const columnRange = columnRanges[columnRangeIndex];
